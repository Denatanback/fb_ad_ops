...
import { BulkHistoricalImportForm } from "@/components/imports/bulk-historical-import-form";
...
export default async function AdminBulkImportsPage({ searchParams }: BulkImportsPageProps) {
  ...
  return (
    <div className="content-frame">
      ...
      >
        <BulkHistoricalImportForm action={uploadBulkHistoricalCsvAction} activeAccounts={activeAccounts} />
      </SectionCard>
